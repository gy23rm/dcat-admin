...
<div class="">
    <a href="javascript:void(0)" class=" font-14 {$this->grid->getRowName()}-orderable" data-id="{$key}" data-direction="1">
    ...
    <a href="javascript:void(0)" class=" font-14 {$this->grid->getRowName()}-orderable" data-id="{$key}" data-direction="0">
